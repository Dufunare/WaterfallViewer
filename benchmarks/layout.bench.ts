...
describe("deterministic 10k incremental layout", () => {
  test("masonry stream + layout", async ({ bench }) => {
    await bench("masonry stream + layout", () => {
  ...
  test("justified stream + layout", async ({ bench }) => {
    await bench("justified stream + layout", () => {
  ...
  test("canvas scene stream + index", async ({ bench }) => {
    await bench("canvas scene stream + index", () => {
...
describe("prepared 50k visibility queries", () => {
  test("masonry middle viewport query", async ({ bench }) => {
    await bench("masonry middle viewport query", () => {
  ...
  test("canvas spatial query", async ({ bench }) => {
    await bench("canvas spatial query", () => {
